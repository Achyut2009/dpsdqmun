    ...
    return (
        <div className="p-10 flex flex-col min-h-screen">
            ...
            <div className="flex flex-col">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">COMMISSION ON CRIME PREVENTION AND CRIMINAL JUSTICE (CCPCJ)</h2>
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">GENERAL ASSEMBLY: DISARMAMENT AND INTERNAL SECURITY COMMITTEE (GA-1)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">GENERAL ASSEMBLY: ECONOMIC AND FINANCIAL COMMITTEE (GA-2)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">UNITED NATIONS HUMAN RIGHTS COUNCIL (UNHRC)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">UNITED NATIONS COMMISSION ON NARCOTIC DRUGS (UNCND)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">WORLD HEALTH ORGANISATION (WHO)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
                ...
                <div className="mb-8 flex flex-col items-center gap-1">
                    <h2 className="text-3xl font-semibold mb-3">PEACE, JUSTICE AND STRONG INSTITUTIONS (UNITED NATIONS SDG-16)</h2>
                    <p className="text-lg text-gray-600 dark:text-gray-300 max-w-3xl text-center">
